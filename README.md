...
<p align="center">
  <img src="https://via.placeholder.com/800x400/1e293b/ffffff?text=PureShield+Dashboard+Preview" alt="PureShield Extension Preview">
</p>
...
*   **🌙 Halal Filter (Optional):** A dedicated mode that filters out inappropriate, NSFW (Not Safe For Work), and haram content based on Islamic values.
    *   *Safe Search Enforcement:* Automatically activates strict safe search on Google, Bing, and DuckDuckGo.
    *   *Domain Blocking:* Blocks access to known inappropriate websites.
    *   *YouTube Filtering:* Hides shorts and potentially distracting content on YouTube to maintain focus.
...
6.  *Done!* The PureShield icon should now appear in your browser's toolbar.
